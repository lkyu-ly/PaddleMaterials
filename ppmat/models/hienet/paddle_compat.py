...
# Tensor shims (_max/_min/split) attached on import; the e3nn subpackage
# __init__ inlines the _max shim with a matching idempotence guard key.

from typing import Optional, Tuple

import paddle

# torch_geometric.typing aliases consumed by the hienet nn modules.
Adj = paddle.Tensor
OptTensor = Optional[paddle.Tensor]
PairTensor = Tuple[paddle.Tensor, paddle.Tensor]
...
if not hasattr(paddle.Tensor, "_min"):
